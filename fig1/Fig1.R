...
# 6. Export as a Vector PDF for Inkscape
# 6. Export as a Vector PDF for Inkscape
ggsave("Parashorea_Geographic_Map_Final.pdf", plot = my_map, width = 6, height = 5, units = "in", device = "pdf", bg = "white")

# 7. Export as a high-resolution PNG (As requested)
ggsave("Parashorea_Geographic_Map_Final.png", plot = my_map, width = 6, height = 5, units = "in", dpi = 300, bg = "white")

# 8. Export as a Planta-ready TIFF (Skip GIMP entirely!)
# This sets the exact 174mm width, 300 DPI, and LZW compression Planta requires
ggsave("Parashorea_Geographic_Map_Final.tiff", plot = my_map, width = 174, height = 145, units = "mm", dpi = 300, compression = "lzw", bg = "white")