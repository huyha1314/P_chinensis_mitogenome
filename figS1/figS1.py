...
# Formatting
ax.set_title(f"ONT Long Reads Spanning Recombination Breakpoint ({contig})", fontsize=14)
ax.set_xlabel("Genomic Coordinate (bp)", fontsize=12)
ax.set_ylabel("Individual Sequenced Reads", fontsize=12)
